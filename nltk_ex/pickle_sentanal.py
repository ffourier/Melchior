...
save_classifier = open("pickled_algos/originalbayes.pickle", "wb")
...
print("LogisitRegression_classifier accuracy percent: ", (nltk.classify.accuracy(LogisticRegression_classifier, testing_set)) * 100)
...
save_classifier = open("pickled_algos/SGDC_classifier", "wb")
